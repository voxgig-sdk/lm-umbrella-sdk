...
|---|---|---|
| `ts/` | @voxgig-sdk/lm-umbrella | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/lm-umbrella \
      --repository voxgig-sdk/lm-umbrella-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/lm-umbrella` shows it, and
`npm trust revoke @voxgig-sdk/lm-umbrella --id=<id>` removes it.
