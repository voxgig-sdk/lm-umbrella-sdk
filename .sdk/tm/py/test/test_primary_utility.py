...
from projectname_sdk import LmUmbrellaSDK
from projectname_sdk.core.spec import LmUmbrellaSpec
from projectname_sdk.core.result import LmUmbrellaResult
from projectname_sdk.core.response import LmUmbrellaResponse
from projectname_sdk.core.operation import LmUmbrellaOperation
from projectname_sdk.core.error import LmUmbrellaError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import LmUmbrellaBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return LmUmbrellaError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = LmUmbrellaSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = LmUmbrellaSDK.test(None, None)
        ...
        class TestInitFeature(LmUmbrellaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(LmUmbrellaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = LmUmbrellaSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = LmUmbrellaSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = LmUmbrellaSDK.test(None, setup_opts)
