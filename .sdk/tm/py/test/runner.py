...
class LmUmbrellaTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LmUmbrellaTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = LmUmbrellaTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = LmUmbrellaTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
