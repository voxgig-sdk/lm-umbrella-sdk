...
class LmUmbrellaTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LmUmbrellaTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = LmUmbrellaTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = LmUmbrellaTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
