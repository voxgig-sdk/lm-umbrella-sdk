# LmUmbrella SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, LmUmbrellaError):
        errmsg = err.msg
    ...
    msg = "LmUmbrellaSDK: " + opname + ": " + errmsg
    ...
    sdk_err = LmUmbrellaError("", msg, ctx)
