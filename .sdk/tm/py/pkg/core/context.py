...
from projectname_sdk.core.control import LmUmbrellaControl
...
class LmUmbrellaContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, LmUmbrellaSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, LmUmbrellaResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, LmUmbrellaResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return LmUmbrellaError(code, msg, self)
