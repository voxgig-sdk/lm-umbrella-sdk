...
// LmUmbrella SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = LmUmbrellaOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(LmUmbrellaOmni::structfix($now, Struct::undef()))
                        !== json_encode(LmUmbrellaOmni::structfix($val, Struct::undef()))) {
