...
// LmUmbrella SDK clienttrack feature
...
class LmUmbrellaClienttrackFeature extends LmUmbrellaBaseFeature
{
    ...
    public function PostConstruct(LmUmbrellaContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'LmUmbrella-SDK';
