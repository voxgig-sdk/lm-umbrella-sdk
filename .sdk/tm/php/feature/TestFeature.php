...
// LmUmbrella SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class LmUmbrellaTestFeature extends LmUmbrellaBaseFeature
{
    ...
    public function init(LmUmbrellaContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (LmUmbrellaContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = LmUmbrellaParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (LmUmbrellaContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(LmUmbrellaContext $ctx, $op, $args): array
    {
