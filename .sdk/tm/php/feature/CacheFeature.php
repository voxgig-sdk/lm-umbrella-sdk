...
class LmUmbrellaCacheFeature extends LmUmbrellaBaseFeature
{
    ...
    private function _through(LmUmbrellaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
