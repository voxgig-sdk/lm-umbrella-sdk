...
class LmUmbrellaPagingFeature extends LmUmbrellaBaseFeature
{
    ...
    private function _graphql_pre_request(LmUmbrellaContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(LmUmbrellaContext $ctx): bool
    {
