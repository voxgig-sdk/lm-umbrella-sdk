...
class LmUmbrellaNetsimFeature extends LmUmbrellaBaseFeature
{
    ...
    private function _simulate(LmUmbrellaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(LmUmbrellaContext $ctx, array $applied): void
    {
        $client = $this->client;
