...
// LmUmbrella SDK utility: graphql
//
...
class LmUmbrellaGraphql
{
    ...
    // equivalent.
    public static function body(LmUmbrellaContext $ctx): mixed
    {
    ...
    public static function errors(LmUmbrellaContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
