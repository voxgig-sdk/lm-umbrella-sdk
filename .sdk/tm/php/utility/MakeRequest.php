...
// LmUmbrella SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class LmUmbrellaMakeRequest
{
    public static function call(LmUmbrellaContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new LmUmbrellaResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new LmUmbrellaResponse($fetched);
        } else {
