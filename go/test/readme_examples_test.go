...
const testSeed = `map[string]any{"entity": map[string]any{"database": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "flat_permission": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "flattened_permission": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "import_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "metadata": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "paginated_permission_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "permission": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "permission_database": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
