...
type FlatPermissionEntity struct {
	name    string
...
func NewFlatPermissionEntity(client *core.LmUmbrellaSDK, entopts map[string]any) *FlatPermissionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FlatPermissionEntity) GetName() string { return e.name }
...
func (e *FlatPermissionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FlatPermissionEntity) Deleted() bool {
	return e.deleted
}


func (e *FlatPermissionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFlatPermissionEntity(e.client, opts)
}

func (e *FlatPermissionEntity) Data(args ...any) any {
...
func (e *FlatPermissionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an FlatPermission; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FlatPermissionEntity) DataTyped(data ...FlatPermission) FlatPermission {
	if len(data) > 0 {
		return typedFrom[FlatPermission](e.Data(asMap(data[0])))
	}
	return typedFrom[FlatPermission](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through FlatPermission (all fields
// optional at the wire level).
func (e *FlatPermissionEntity) MatchTyped(match ...FlatPermission) FlatPermission {
	if len(match) > 0 {
		return typedFrom[FlatPermission](e.Match(asMap(match[0])))
	}
	return typedFrom[FlatPermission](e.Match())
}
...
func (e *FlatPermissionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FlatPermissionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FlatPermissionLoadMatch and returns an FlatPermission. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FlatPermissionEntity) LoadTyped(reqmatch FlatPermissionLoadMatch, ctrl map[string]any) (FlatPermission, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return FlatPermission{}, err
	}
	return typedFrom[FlatPermission](res), nil
}



func (e *FlatPermissionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FlatPermissionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FlatPermissionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FlatPermissionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FlatPermissionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
