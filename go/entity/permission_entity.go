...
func NewPermissionEntity(client *core.LmUmbrellaSDK, entopts map[string]any) *PermissionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PermissionEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// PermissionRemoveMatch and returns an Permission. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *PermissionEntity) RemoveTyped(reqmatch PermissionRemoveMatch, ctrl map[string]any) (Permission, error) {
