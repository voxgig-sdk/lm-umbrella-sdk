...
type FlattenedPermissionEntity struct {
	name    string
...
func NewFlattenedPermissionEntity(client *core.LmUmbrellaSDK, entopts map[string]any) *FlattenedPermissionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FlattenedPermissionEntity) GetName() string { return e.name }
...
func (e *FlattenedPermissionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FlattenedPermissionEntity) Deleted() bool {
	return e.deleted
}


func (e *FlattenedPermissionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFlattenedPermissionEntity(e.client, opts)
}

func (e *FlattenedPermissionEntity) Data(args ...any) any {
...
func (e *FlattenedPermissionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an FlattenedPermission; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FlattenedPermissionEntity) DataTyped(data ...FlattenedPermission) FlattenedPermission {
	if len(data) > 0 {
		return typedFrom[FlattenedPermission](e.Data(asMap(data[0])))
	}
	return typedFrom[FlattenedPermission](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through FlattenedPermission (all fields
// optional at the wire level).
func (e *FlattenedPermissionEntity) MatchTyped(match ...FlattenedPermission) FlattenedPermission {
	if len(match) > 0 {
		return typedFrom[FlattenedPermission](e.Match(asMap(match[0])))
	}
	return typedFrom[FlattenedPermission](e.Match())
}
...
func (e *FlattenedPermissionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FlattenedPermissionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// FlattenedPermissionListMatch and returns []FlattenedPermission. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FlattenedPermissionEntity) ListTyped(reqmatch FlattenedPermissionListMatch, ctrl map[string]any) ([]FlattenedPermission, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[FlattenedPermission](res), nil
}




func (e *FlattenedPermissionEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// FlattenedPermissionCreateData and returns an FlattenedPermission. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *FlattenedPermissionEntity) CreateTyped(reqdata FlattenedPermissionCreateData, ctrl map[string]any) (FlattenedPermission, error) {
...
func (e *FlattenedPermissionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FlattenedPermissionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FlattenedPermissionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
