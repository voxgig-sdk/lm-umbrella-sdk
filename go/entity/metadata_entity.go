...
func NewMetadataEntity(client *core.LmUmbrellaSDK, entopts map[string]any) *MetadataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MetadataEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MetadataLoadMatch and returns an Metadata. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MetadataEntity) LoadTyped(reqmatch MetadataLoadMatch, ctrl map[string]any) (Metadata, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Metadata{}, err
	}
	return typedFrom[Metadata](res), nil
}
...
func (e *MetadataEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// MetadataCreateData and returns an Metadata. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *MetadataEntity) CreateTyped(reqdata MetadataCreateData, ctrl map[string]any) (Metadata, error) {
...
func (e *MetadataEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// MetadataUpdateData and returns an Metadata. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *MetadataEntity) UpdateTyped(reqdata MetadataUpdateData, ctrl map[string]any) (Metadata, error) {
