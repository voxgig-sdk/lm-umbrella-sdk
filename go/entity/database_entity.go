...
func NewDatabaseEntity(client *core.LmUmbrellaSDK, entopts map[string]any) *DatabaseEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DatabaseEntity) GetName() string { return e.name }
...
func (e *DatabaseEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DatabaseEntity) Deleted() bool {
	return e.deleted
}


func (e *DatabaseEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDatabaseEntity(e.client, opts)
}

func (e *DatabaseEntity) Data(args ...any) any {
...
func (e *DatabaseEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Database; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DatabaseEntity) DataTyped(data ...Database) Database {
	if len(data) > 0 {
		return typedFrom[Database](e.Data(asMap(data[0])))
	}
	return typedFrom[Database](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Database (all fields
// optional at the wire level).
func (e *DatabaseEntity) MatchTyped(match ...Database) Database {
	if len(match) > 0 {
		return typedFrom[Database](e.Match(asMap(match[0])))
	}
	return typedFrom[Database](e.Match())
}
...
func (e *DatabaseEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DatabaseEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DatabaseEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DatabaseEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DatabaseEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *DatabaseEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DatabaseRemoveMatch and returns an Database. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *DatabaseEntity) RemoveTyped(reqmatch DatabaseRemoveMatch, ctrl map[string]any) (Database, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return Database{}, err
	}
	return typedFrom[Database](res), nil
}



func (e *DatabaseEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
