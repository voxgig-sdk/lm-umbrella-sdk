...
type ImportStatusEntity struct {
	name    string
...
func NewImportStatusEntity(client *core.LmUmbrellaSDK, entopts map[string]any) *ImportStatusEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ImportStatusEntity) GetName() string { return e.name }
...
func (e *ImportStatusEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ImportStatusEntity) Deleted() bool {
	return e.deleted
}


func (e *ImportStatusEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewImportStatusEntity(e.client, opts)
}

func (e *ImportStatusEntity) Data(args ...any) any {
...
func (e *ImportStatusEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ImportStatus; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ImportStatusEntity) DataTyped(data ...ImportStatus) ImportStatus {
	if len(data) > 0 {
		return typedFrom[ImportStatus](e.Data(asMap(data[0])))
	}
	return typedFrom[ImportStatus](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ImportStatus (all fields
// optional at the wire level).
func (e *ImportStatusEntity) MatchTyped(match ...ImportStatus) ImportStatus {
	if len(match) > 0 {
		return typedFrom[ImportStatus](e.Match(asMap(match[0])))
	}
	return typedFrom[ImportStatus](e.Match())
}
...
func (e *ImportStatusEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ImportStatusEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ImportStatusEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ImportStatusListMatch and returns []ImportStatus. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ImportStatusEntity) ListTyped(reqmatch ImportStatusListMatch, ctrl map[string]any) ([]ImportStatus, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ImportStatus](res), nil
}




func (e *ImportStatusEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// ImportStatusCreateData and returns an ImportStatus. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ImportStatusEntity) CreateTyped(reqdata ImportStatusCreateData, ctrl map[string]any) (ImportStatus, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return ImportStatus{}, err
	}
	return typedFrom[ImportStatus](res), nil
}



func (e *ImportStatusEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ImportStatusEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ImportStatusEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
