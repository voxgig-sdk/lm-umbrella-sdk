// Command LmUmbrella-mcp is an MCP server exposing the LmUmbrella
// SDK as MCP tools.
//
// Two tools are registered:
//
//	LmUmbrella_list  — list records of an entity
//	LmUmbrella_load  — load a single record of an entity
//
