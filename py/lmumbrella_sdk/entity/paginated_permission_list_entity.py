...
class PaginatedPermissionListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PaginatedPermissionListEntity(self._client, opts)
    ...
    def data_get(self) -> PaginatedPermissionList:
    ...
    def match_get(self) -> PaginatedPermissionList:
    ...
    def create(self, reqdata: PaginatedPermissionListCreateData, ctrl=None) -> PaginatedPermissionList:
        utility = self._utility
