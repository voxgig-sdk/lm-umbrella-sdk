...
class MetadataEntity:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Metadata:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Metadata().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: MetadataCreateData, ctrl=None) -> Metadata:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: MetadataUpdateData, ctrl=None) -> Metadata:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
