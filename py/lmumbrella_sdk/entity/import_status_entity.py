...
class ImportStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ImportStatusEntity(self._client, opts)
    ...
    def data_get(self) -> ImportStatus:
    ...
    def match_get(self) -> ImportStatus:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ImportStatus]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ImportStatus().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ImportStatusCreateData, ctrl=None) -> ImportStatus:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
