    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set LMUMBRELLA_TEST_IMPORT_STATUS_ENTID JSON to run live")
        client = setup["client"]
        ...
        import_status_ref01_data = helpers.to_map(import_status_ref01_ent.create(import_status_ref01_data, None))
...
def _import_status_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("LMUMBRELLA_TEST_IMPORT_STATUS_ENTID"))
