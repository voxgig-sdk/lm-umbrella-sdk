...
class LmUmbrellaTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LmUmbrellaTestRunner.getenv("LMUMBRELLA_TEST_LIVE")
        override = LmUmbrellaTestRunner.getenv("LMUMBRELLA_TEST_OVERRIDE")
        ...
        explain = LmUmbrellaTestRunner.getenv("LMUMBRELLA_TEST_EXPLAIN")
