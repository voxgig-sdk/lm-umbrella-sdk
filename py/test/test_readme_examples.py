# LmUmbrella SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions LmUmbrellaSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both LmUmbrellaSDK(...) and LmUmbrellaSDK.test(...) become
#      LmUmbrellaSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "lmumbrella_sdk"
_SDK_CLASS = "LmUmbrellaSDK"
...
_ENTITIES = {
    "Database": "database",
    "FlatPermission": "flat_permission",
    "FlattenedPermission": "flattened_permission",
    "ImportStatus": "import_status",
    "Metadata": "metadata",
    "PaginatedPermissionList": "paginated_permission_list",
    "Permission": "permission",
    "PermissionDatabase": "permission_database",
}
