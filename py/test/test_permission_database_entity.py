    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set LM_UMBRELLA_TEST_PERMISSION_DATABASE_ENTID JSON to run live")
        client = setup["client"]
        ...
        permission_database_ref01_resdata_up0 = helpers.to_map(runner.entity_data(permission_database_ref01_ent.update(permission_database_ref01_data_up0_up, None)))
...
def _permission_database_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("LM_UMBRELLA_TEST_PERMISSION_DATABASE_ENTID"))
