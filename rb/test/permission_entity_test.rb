...
class PermissionEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set LMUMBRELLA_TEST_PERMISSION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def permission_basic_setup(extra)
  ...
  entid_env_raw = ENV["LMUMBRELLA_TEST_PERMISSION_ENTID"]
