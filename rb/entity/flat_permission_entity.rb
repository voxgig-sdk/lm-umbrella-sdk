...
class FlatPermissionEntity
  ...
  def make
    opts = @_entopts.dup
    FlatPermissionEntity.new(@_client, opts)
  end
  ...
  # @return [FlatPermission, Hash] the current FlatPermission data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of FlatPermission fields)
  def match_get
  ...
  #
  # @param reqmatch [FlatPermissionLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.FlatPermission.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [FlatPermission, Hash] the loaded FlatPermission; raises LmUmbrellaError on failure
