...
class MetadataEntity
  ...
  #
  # @param reqmatch [MetadataLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Metadata.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Metadata, Hash] the loaded Metadata; raises LmUmbrellaError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Metadata>, Array] the matching Metadata items; raises LmUmbrellaError on failure
  ...
  #
  # @param reqdata [MetadataCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Metadata, Hash] the created Metadata; raises LmUmbrellaError on failure
  ...
  #
  # @param reqdata [MetadataUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Metadata, Hash] the updated Metadata; raises LmUmbrellaError on failure
