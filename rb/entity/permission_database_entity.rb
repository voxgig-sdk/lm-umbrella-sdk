...
class PermissionDatabaseEntity
  ...
  def make
    opts = @_entopts.dup
    PermissionDatabaseEntity.new(@_client, opts)
  end
  ...
  # @return [PermissionDatabase, Hash] the current PermissionDatabase data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PermissionDatabase fields)
  def match_get
  ...
  #
  # @param reqmatch [PermissionDatabaseLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.PermissionDatabase.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [PermissionDatabase, Hash] the loaded PermissionDatabase; raises LmUmbrellaError on failure
  ...
  #
  # @param reqmatch [PermissionDatabaseListMatch, Hash, nil] match filter (any subset of
  #   PermissionDatabase fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<PermissionDatabase>, Array] the matching PermissionDatabase items; raises LmUmbrellaError on failure
  ...
  #
  # @param reqdata [PermissionDatabaseUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [PermissionDatabase, Hash] the updated PermissionDatabase; raises LmUmbrellaError on failure
