...
class ImportStatusEntity
  ...
  def make
    opts = @_entopts.dup
    ImportStatusEntity.new(@_client, opts)
  end
  ...
  # @return [ImportStatus, Hash] the current ImportStatus data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ImportStatus fields)
  def match_get
  ...
  #
  # @param reqmatch [ImportStatusListMatch, Hash, nil] match filter (any subset of
  #   ImportStatus fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ImportStatus>, Array] the matching ImportStatus items; raises LmUmbrellaError on failure
  ...
  #
  # @param reqdata [ImportStatusCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ImportStatus, Hash] the created ImportStatus; raises LmUmbrellaError on failure
