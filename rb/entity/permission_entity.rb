...
class PermissionEntity
  ...
  #
  # @param reqdata [PermissionUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Permission, Hash] the updated Permission; raises LmUmbrellaError on failure
  ...
  #
  # @param reqmatch [PermissionRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Permission, Hash] the removed Permission; raises LmUmbrellaError on failure
