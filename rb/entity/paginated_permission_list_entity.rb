...
class PaginatedPermissionListEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "paginated_permission_list"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    PaginatedPermissionListEntity.new(@_client, opts)
  end
  ...
  # @return [PaginatedPermissionList, Hash] the current PaginatedPermissionList data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PaginatedPermissionList fields)
  def match_get
  ...
  #
  # @param reqdata [PaginatedPermissionListCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [PaginatedPermissionList, Hash] the created PaginatedPermissionList; raises LmUmbrellaError on failure
