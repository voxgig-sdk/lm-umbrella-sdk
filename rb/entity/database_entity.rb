...
class DatabaseEntity
  ...
  def make
    opts = @_entopts.dup
    DatabaseEntity.new(@_client, opts)
  end
  ...
  # @return [Database, Hash] the current Database data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Database fields)
  def match_get
  ...
  #
  # @param reqmatch [DatabaseRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Database, Hash] the removed Database; raises LmUmbrellaError on failure
