...
(0, node_test_1.describe)('PermissionDatabaseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-permission_database', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-permission_database', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-permission_database', async (t) => {
        ...
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-permission_database', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
//# sourceMappingURL=PermissionDatabaseDirect.test.js.map