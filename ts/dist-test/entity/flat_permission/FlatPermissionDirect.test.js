...
(0, node_test_1.describe)('FlatPermissionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-flat_permission', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-flat_permission', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["database_id01", "id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LM_UMBRELLA_TEST_FLAT_PERMISSION_ENTID'];
...
//# sourceMappingURL=FlatPermissionDirect.test.js.map