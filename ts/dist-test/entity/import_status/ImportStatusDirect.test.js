...
(0, node_test_1.describe)('ImportStatusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-import_status', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-import_status', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LM_UMBRELLA_TEST_IMPORT_STATUS_ENTID'];
...
//# sourceMappingURL=ImportStatusDirect.test.js.map