...
function envOverride(m) {
    if ('TRUE' === process.env.LMUMBRELLA_TEST_LIVE ||
        'TRUE' === process.env.LMUMBRELLA_TEST_OVERRIDE) {
    ...
    m.LMUMBRELLA_TEST_EXPLAIN = process.env.LMUMBRELLA_TEST_EXPLAIN || m.LMUMBRELLA_TEST_EXPLAIN;
    return m;
}
