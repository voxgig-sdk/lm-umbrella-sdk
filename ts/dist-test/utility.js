...
function envOverride(m) {
    if ('TRUE' === process.env.LM_UMBRELLA_TEST_LIVE ||
        'TRUE' === process.env.LM_UMBRELLA_TEST_OVERRIDE) {
    ...
    m.LM_UMBRELLA_TEST_EXPLAIN = process.env.LM_UMBRELLA_TEST_EXPLAIN || m.LM_UMBRELLA_TEST_EXPLAIN;
    return m;
}
