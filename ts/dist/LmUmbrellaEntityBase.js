...
exports.LmUmbrellaEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends LmUmbrellaEntityBase<Advice>`.
class LmUmbrellaEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.LmUmbrellaEntityBase = LmUmbrellaEntityBase;
//# sourceMappingURL=LmUmbrellaEntityBase.js.map