...
exports.SDK = exports.LmUmbrellaSDK = exports.LmUmbrellaEntityBase = exports.BaseFeature = exports.config = exports.stdutil = void 0;
const DatabaseEntity_1 = require("./entity/DatabaseEntity");
const FlatPermissionEntity_1 = require("./entity/FlatPermissionEntity");
const FlattenedPermissionEntity_1 = require("./entity/FlattenedPermissionEntity");
const ImportStatusEntity_1 = require("./entity/ImportStatusEntity");
const MetadataEntity_1 = require("./entity/MetadataEntity");
const PaginatedPermissionListEntity_1 = require("./entity/PaginatedPermissionListEntity");
const PermissionEntity_1 = require("./entity/PermissionEntity");
const PermissionDatabaseEntity_1 = require("./entity/PermissionDatabaseEntity");
const node_util_1 = require("node:util");
const Config_1 = require("./Config");
Object.defineProperty(exports, "config", { enumerable: true, get: function () { return Config_1.config; } });
const LmUmbrellaEntityBase_1 = require("./LmUmbrellaEntityBase");
Object.defineProperty(exports, "LmUmbrellaEntityBase", { enumerable: true, get: function () { return LmUmbrellaEntityBase_1.LmUmbrellaEntityBase; } });
...
class LmUmbrellaSDK {
    ...
    static test(testoptsarg, sdkoptsarg) {
        ...
        const testsdk = new LmUmbrellaSDK(sdkopts);
        testsdk._mode = 'test';
        return testsdk;
    }
    tester(testopts, sdkopts) {
        return LmUmbrellaSDK.test(testopts, sdkopts);
    }
    toJSON() {
        return { name: 'LmUmbrella' };
    }
    toString() {
        return 'LmUmbrella ' + this._utility.struct.jsonify(this.toJSON());
    }
    [node_util_1.inspect.custom]() {
        return this.toString();
    }
}
exports.LmUmbrellaSDK = LmUmbrellaSDK;
const SDK = LmUmbrellaSDK;
exports.SDK = SDK;
//# sourceMappingURL=LmUmbrellaSDK.js.map