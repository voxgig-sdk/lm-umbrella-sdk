...
// LmUmbrella SDK Database entity
...
class DatabaseEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DatabaseEntity($this->_client, $opts);
    }

    /**
     * @param Database|array $args Database data (assoc-array) to store.
     */
    ...
    /**
     * @return Database|array The current Database data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Database fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Database fields).
     */
    ...
    /**
     * Remove an Database matching the given criteria.
     *
     * @param DatabaseRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DatabaseRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Database|array The removed Database as an assoc-array at the
