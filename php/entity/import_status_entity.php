...
// LmUmbrella SDK ImportStatus entity
...
class ImportStatusEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ImportStatusEntity($this->_client, $opts);
    }

    /**
     * @param ImportStatus|array $args ImportStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return ImportStatus|array The current ImportStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ImportStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ImportStatus fields).
     */
    ...
    /**
     * List ImportStatus items matching the given filter.
     *
     * @param ImportStatusListMatch|array|null $reqmatch Match filter (any subset
     *   of ImportStatus fields) as an assoc-array; ImportStatusListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ImportStatus[]|array A list of ImportStatus items as assoc-arrays at
    ...
    /**
     * Create a new ImportStatus.
     *
     * @param ImportStatusCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ImportStatusCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ImportStatus|array The created ImportStatus as an assoc-array at the
