...
// LmUmbrella SDK PaginatedPermissionList entity
...
class PaginatedPermissionListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "paginated_permission_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PaginatedPermissionListEntity($this->_client, $opts);
    }

    /**
     * @param PaginatedPermissionList|array $args PaginatedPermissionList data (assoc-array) to store.
     */
    ...
    /**
     * @return PaginatedPermissionList|array The current PaginatedPermissionList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PaginatedPermissionList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PaginatedPermissionList fields).
     */
    ...
    /**
     * Create a new PaginatedPermissionList.
     *
     * @param PaginatedPermissionListCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PaginatedPermissionListCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PaginatedPermissionList|array The created PaginatedPermissionList as an assoc-array at the
