...
// LmUmbrella SDK Permission entity
...
class PermissionEntity
{
     ...
     *
     * @param PermissionUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PermissionUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Permission|array The updated Permission as an assoc-array at the
    ...
    /**
     * Remove an Permission matching the given criteria.
     *
     * @param PermissionRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; PermissionRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Permission|array The removed Permission as an assoc-array at the
     *   SDK boundary; throws LmUmbrellaError on failure (item-5 convention).
     */
