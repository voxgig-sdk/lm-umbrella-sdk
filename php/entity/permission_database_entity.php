...
// LmUmbrella SDK PermissionDatabase entity
...
class PermissionDatabaseEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "permission_database";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PermissionDatabaseEntity($this->_client, $opts);
    }

    /**
     * @param PermissionDatabase|array $args PermissionDatabase data (assoc-array) to store.
     */
    ...
    /**
     * @return PermissionDatabase|array The current PermissionDatabase data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PermissionDatabase fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PermissionDatabase fields).
     */
    ...
    /**
     * Load a single PermissionDatabase.
     *
     * @param PermissionDatabaseLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PermissionDatabaseLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PermissionDatabase|array The loaded PermissionDatabase as an assoc-array at the
    ...
    /**
     * List PermissionDatabase items matching the given filter.
     *
     * @param PermissionDatabaseListMatch|array|null $reqmatch Match filter (any subset
     *   of PermissionDatabase fields) as an assoc-array; PermissionDatabaseListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PermissionDatabase[]|array A list of PermissionDatabase items as assoc-arrays at
    ...
    /**
     * Update an existing PermissionDatabase.
     *
     * @param PermissionDatabaseUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PermissionDatabaseUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PermissionDatabase|array The updated PermissionDatabase as an assoc-array at the
     *   SDK boundary; throws LmUmbrellaError on failure (item-5 convention).
     */
