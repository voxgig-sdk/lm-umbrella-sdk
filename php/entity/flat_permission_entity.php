...
// LmUmbrella SDK FlatPermission entity
...
class FlatPermissionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FlatPermissionEntity($this->_client, $opts);
    }

    /**
     * @param FlatPermission|array $args FlatPermission data (assoc-array) to store.
     */
    ...
    /**
     * @return FlatPermission|array The current FlatPermission data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of FlatPermission fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of FlatPermission fields).
     */
    ...
    /**
     * Load a single FlatPermission.
     *
     * @param FlatPermissionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed FlatPermissionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FlatPermission|array The loaded FlatPermission as an assoc-array at the
