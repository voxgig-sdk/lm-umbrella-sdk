...
// LmUmbrella SDK Metadata entity
...
class MetadataEntity
{
    ...
    /**
     * Load a single Metadata.
     *
     * @param MetadataLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MetadataLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Metadata|array The loaded Metadata as an assoc-array at the
     ...
     *
     * @param MetadataCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MetadataCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Metadata|array The created Metadata as an assoc-array at the
     *   SDK boundary; throws LmUmbrellaError on failure (item-5 convention).
     */
     ...
     *
     * @param MetadataUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MetadataUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Metadata|array The updated Metadata as an assoc-array at the
     *   SDK boundary; throws LmUmbrellaError on failure (item-5 convention).
     */
