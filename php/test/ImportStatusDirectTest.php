...
class ImportStatusDirectTest extends TestCase
{
    public function test_direct_list_import_status(): void
    {
        $setup = import_status_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-import_status", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
