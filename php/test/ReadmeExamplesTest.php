...
// LmUmbrella SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (LmUmbrellaSDK::test)
...
{
    private const SDK_CLASS = 'LmUmbrellaSDK';
    ...
    private const SDK_BASE = 'lmumbrella_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../lmumbrella_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
