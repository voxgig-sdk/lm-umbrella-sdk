...
{
    private static function utility(): LmUmbrellaUtility
    {
        return new LmUmbrellaUtility();
    }
    ...
    private static function ctx(array $over = []): LmUmbrellaContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new LmUmbrellaContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new LmUmbrellaOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof LmUmbrellaError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new LmUmbrellaOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = LmUmbrellaMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new LmUmbrellaOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = LmUmbrellaMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new LmUmbrellaOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = LmUmbrellaMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new LmUmbrellaSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = LmUmbrellaMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new LmUmbrellaResponse([]),
            'result' => new LmUmbrellaResult([]),
        ]);
        [, $err] = LmUmbrellaMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new LmUmbrellaSpec([]),
            'response' => null,
            'result' => new LmUmbrellaResult([]),
        ]);
        [, $err] = LmUmbrellaMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new LmUmbrellaSpec(['step' => 's']),
            'response' => new LmUmbrellaResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new LmUmbrellaResult([]),
        ]);
        [, $err] = LmUmbrellaMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new LmUmbrellaSpec(['step' => 's']),
            'response' => new LmUmbrellaResponse(self::resp(200, ['v' => 1])),
            'result' => new LmUmbrellaResult([]),
        ]);
        [, $err] = LmUmbrellaMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new LmUmbrellaSpec(['step' => 's']),
            'response' => new LmUmbrellaResponse(self::resp(200, ['v' => 2])),
            'result' => new LmUmbrellaResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        LmUmbrellaMakeResponse::call($ctx);
    ...
    {
        $preset = new LmUmbrellaResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new LmUmbrellaSpec([]),
            'response' => new LmUmbrellaResponse([]),
            'result' => new LmUmbrellaResult([]),
        ...
        [$got, $err] = LmUmbrellaMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new LmUmbrellaResult([])]);
        [, $err] = LmUmbrellaMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new LmUmbrellaSpec([]), 'result' => null]);
        [, $err] = LmUmbrellaMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new LmUmbrellaSpec(['step' => 's']),
            'result' => new LmUmbrellaResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new LmUmbrellaOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = LmUmbrellaMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new LmUmbrellaSpec(['step' => 's']),
            'result' => new LmUmbrellaResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new LmUmbrellaOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = LmUmbrellaMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new LmUmbrellaResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new LmUmbrellaSpec([]),
            'result' => new LmUmbrellaResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = LmUmbrellaMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = LmUmbrellaMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new LmUmbrellaError('boom', 'boom');
        $utility->fetcher = function (LmUmbrellaContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new LmUmbrellaSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = LmUmbrellaMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (LmUmbrellaContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = LmUmbrellaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(LmUmbrellaResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        LmUmbrellaMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (LmUmbrellaContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new LmUmbrellaSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = LmUmbrellaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new LmUmbrellaResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new LmUmbrellaSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = LmUmbrellaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = LmUmbrellaMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = LmUmbrellaMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new LmUmbrellaResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, LmUmbrellaDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new LmUmbrellaResult(['ok' => false])]);
        $this->expectException(LmUmbrellaError::class);
        LmUmbrellaDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new LmUmbrellaResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', LmUmbrellaMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        LmUmbrellaMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new LmUmbrellaBaseFeature();
        $b = new LmUmbrellaBaseFeature();
        LmUmbrellaFeatureAdd::call($ctx, $a);
        LmUmbrellaFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): LmUmbrellaBaseFeature
    {
        $f = new LmUmbrellaBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        LmUmbrellaFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): LmUmbrellaContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new LmUmbrellaSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = LmUmbrellaPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        LmUmbrellaPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new LmUmbrellaResponse(['headers' => null]),
            'result' => new LmUmbrellaResult([]),
        ]);
        LmUmbrellaResultHeaders::call($ctx);
