...
class FlatPermissionDirectTest extends TestCase
{
    public function test_direct_load_flat_permission(): void
    {
        $setup = flat_permission_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-flat_permission", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
