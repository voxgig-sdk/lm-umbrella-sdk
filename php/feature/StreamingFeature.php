...
// LmUmbrella SDK streaming feature
...
class LmUmbrellaStreamingFeature extends LmUmbrellaBaseFeature
{
    ...
    private function _iterate(LmUmbrellaResult $result): \Generator
    {
    ...
    private function _streamable(LmUmbrellaContext $ctx): bool
    {
