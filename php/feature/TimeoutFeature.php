...
// LmUmbrella SDK timeout feature
...
class LmUmbrellaTimeoutFeature extends LmUmbrellaBaseFeature
{
    ...
    private function _with_timeout(LmUmbrellaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(LmUmbrellaContext $_ctx, float $ms): void
    {
        $client = $this->client;
