...
// LmUmbrella SDK telemetry feature
...
class LmUmbrellaTelemetryFeature extends LmUmbrellaBaseFeature
{
    ...
    private function _close(LmUmbrellaContext $ctx, bool $ok): void
    {
