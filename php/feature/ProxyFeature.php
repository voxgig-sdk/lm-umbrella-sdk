...
class LmUmbrellaProxyFeature extends LmUmbrellaBaseFeature
{
    ...
    public function init(LmUmbrellaContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (LmUmbrellaContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
