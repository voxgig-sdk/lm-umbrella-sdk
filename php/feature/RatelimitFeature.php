...
// LmUmbrella SDK ratelimit feature
...
class LmUmbrellaRatelimitFeature extends LmUmbrellaBaseFeature
{
    ...
    private function _acquire(LmUmbrellaContext $ctx): void
    {
    ...
    private function _track(LmUmbrellaContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
