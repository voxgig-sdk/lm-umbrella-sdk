...
class LmUmbrellaRbacFeature extends LmUmbrellaBaseFeature
{
    ...
    private function _required(LmUmbrellaContext $ctx): ?string
    {
    ...
    private function _reject(LmUmbrellaContext $ctx, string $required): void
    {
    ...
    private function _track(LmUmbrellaContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
