...
// LmUmbrella SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class LmUmbrellaTransformResponse
{
    public static function call(LmUmbrellaContext $ctx): mixed
    {
        ...
        $transform = LmUmbrellaHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
