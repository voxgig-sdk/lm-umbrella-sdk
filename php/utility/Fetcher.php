...
// LmUmbrella SDK utility: fetcher

class LmUmbrellaFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; LmUmbrellaSDK/1.0)';
    ...
    public static function call(LmUmbrellaContext $ctx, string $fullurl, array $fetchdef): array
    {
