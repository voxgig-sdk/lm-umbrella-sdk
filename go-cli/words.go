...
func registerSDKWords(r *eng.Registry, client *sdk.LmUmbrellaSDK) {
...
func runOp(client *sdk.LmUmbrellaSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
