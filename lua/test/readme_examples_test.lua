...
local SDK_MODULE = "lm-umbrella_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["database"] = { ["test01"] = { id = "test01" } }, ["flat_permission"] = { ["test01"] = { id = "test01" } }, ["flattened_permission"] = { ["test01"] = { id = "test01" } }, ["import_status"] = { ["test01"] = { id = "test01" } }, ["metadata"] = { ["test01"] = { id = "test01" } }, ["paginated_permission_list"] = { ["test01"] = { id = "test01" } }, ["permission"] = { ["test01"] = { id = "test01" } }, ["permission_database"] = { ["test01"] = { id = "test01" } } } }'
