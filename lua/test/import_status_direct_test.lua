...
describe("ImportStatusDirect", function()
  it("should direct-list-import_status", function()
    local setup = import_status_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-import_status", setup.live and "live" or "unit")
...
function import_status_direct_setup(mockres)
