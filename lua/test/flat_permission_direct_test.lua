...
describe("FlatPermissionDirect", function()
  it("should direct-load-flat_permission", function()
    local setup = flat_permission_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-flat_permission", setup.live and "live" or "unit")
...
function flat_permission_direct_setup(mockres)
