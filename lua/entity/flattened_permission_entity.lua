...
local FlattenedPermissionEntity = {}
FlattenedPermissionEntity.__index = FlattenedPermissionEntity


function FlattenedPermissionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FlattenedPermissionEntity)
  self._name = "flattened_permission"
  self._client = client
...
function FlattenedPermissionEntity:get_name()
  return self._name
end


function FlattenedPermissionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FlattenedPermissionEntity.new(self._client, opts)
end
...
function FlattenedPermissionEntity:mark_deleted()
  self._deleted = true
end


function FlattenedPermissionEntity:deleted()
  return true == self._deleted
end


function FlattenedPermissionEntity:data_set(args)
  if args ~= nil then
...
function FlattenedPermissionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FlattenedPermissionEntity:match_set(args)
  if args ~= nil then
...
function FlattenedPermissionEntity:match_get()
...
function FlattenedPermissionEntity:stream(action, args, callopts)
...
---@param reqmatch FlattenedPermissionLoadMatch
---@param ctrl? table
---@return FlattenedPermission
---@return string? err
function FlattenedPermissionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch FlattenedPermissionListMatch
---@param ctrl? table
---@return FlattenedPermission[]
---@return string? err
function FlattenedPermissionEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata FlattenedPermissionCreateData
---@param ctrl? table
---@return FlattenedPermission
---@return string? err
function FlattenedPermissionEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function FlattenedPermissionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return FlattenedPermissionEntity
