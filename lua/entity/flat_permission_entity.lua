...
local FlatPermissionEntity = {}
FlatPermissionEntity.__index = FlatPermissionEntity


function FlatPermissionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FlatPermissionEntity)
  self._name = "flat_permission"
  self._client = client
...
function FlatPermissionEntity:get_name()
  return self._name
end


function FlatPermissionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FlatPermissionEntity.new(self._client, opts)
end
...
function FlatPermissionEntity:mark_deleted()
  self._deleted = true
end


function FlatPermissionEntity:deleted()
  return true == self._deleted
end


function FlatPermissionEntity:data_set(args)
  if args ~= nil then
...
function FlatPermissionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FlatPermissionEntity:match_set(args)
  if args ~= nil then
...
function FlatPermissionEntity:match_get()
...
function FlatPermissionEntity:stream(action, args, callopts)
...
---@param reqmatch FlatPermissionLoadMatch
---@param ctrl? table
---@return FlatPermission
---@return string? err
function FlatPermissionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function FlatPermissionEntity:_run_op(ctx, post_done)
  local utility = self._utility
