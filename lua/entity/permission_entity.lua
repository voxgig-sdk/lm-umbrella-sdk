...
---@param reqdata PermissionUpdateData
---@param ctrl? table
---@return Permission
---@return string? err
function PermissionEntity:update(reqdata, ctrl)
  local utility = self._utility
...
---@param reqmatch PermissionRemoveMatch
---@param ctrl? table
---@return Permission
---@return string? err
function PermissionEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
