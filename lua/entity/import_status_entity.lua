...
local ImportStatusEntity = {}
ImportStatusEntity.__index = ImportStatusEntity


function ImportStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ImportStatusEntity)
  self._name = "import_status"
  self._client = client
...
function ImportStatusEntity:get_name()
  return self._name
end


function ImportStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ImportStatusEntity.new(self._client, opts)
end
...
function ImportStatusEntity:mark_deleted()
  self._deleted = true
end


function ImportStatusEntity:deleted()
  return true == self._deleted
end


function ImportStatusEntity:data_set(args)
  if args ~= nil then
...
function ImportStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ImportStatusEntity:match_set(args)
  if args ~= nil then
...
function ImportStatusEntity:match_get()
...
function ImportStatusEntity:stream(action, args, callopts)
...
---@param reqmatch ImportStatusListMatch
---@param ctrl? table
---@return ImportStatus[]
---@return string? err
function ImportStatusEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ImportStatusCreateData
---@param ctrl? table
---@return ImportStatus
---@return string? err
function ImportStatusEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ImportStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
