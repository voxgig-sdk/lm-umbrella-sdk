...
---@param reqdata MetadataCreateData
---@param ctrl? table
---@return Metadata
---@return string? err
function MetadataEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata MetadataUpdateData
---@param ctrl? table
---@return Metadata
---@return string? err
function MetadataEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
