...
local PaginatedPermissionListEntity = {}
PaginatedPermissionListEntity.__index = PaginatedPermissionListEntity


function PaginatedPermissionListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PaginatedPermissionListEntity)
  self._name = "paginated_permission_list"
  self._client = client
...
function PaginatedPermissionListEntity:get_name()
  return self._name
end


function PaginatedPermissionListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PaginatedPermissionListEntity.new(self._client, opts)
end
...
function PaginatedPermissionListEntity:mark_deleted()
  self._deleted = true
end


function PaginatedPermissionListEntity:deleted()
  return true == self._deleted
end


function PaginatedPermissionListEntity:data_set(args)
  if args ~= nil then
...
function PaginatedPermissionListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PaginatedPermissionListEntity:match_set(args)
  if args ~= nil then
...
function PaginatedPermissionListEntity:match_get()
...
function PaginatedPermissionListEntity:stream(action, args, callopts)
...
---@param reqdata PaginatedPermissionListCreateData
---@param ctrl? table
---@return PaginatedPermissionList
---@return string? err
function PaginatedPermissionListEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function PaginatedPermissionListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PaginatedPermissionListEntity
