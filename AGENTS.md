...
**Entities** (8): `Database`, `FlatPermission`, `FlattenedPermission`, `ImportStatus`, `Metadata`, `PaginatedPermissionList`, `Permission`, `PermissionDatabase`.
